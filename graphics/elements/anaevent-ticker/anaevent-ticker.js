	...
	Polymer({
		...
		showSchedule() {
			this.tl.call(() => {
				...
				this.customStyle['--anaevent-ticker-content-color'] = '#f47425';
				this.updateStyles();
		...
		showChallenges() {
			...
			this.tl.call(() => {
				...
				this.customStyle['--anaevent-ticker-content-color'] = '#12a824';
				this.updateStyles();
		...
		showWars() {
			...
			this.tl.call(() => {
				...
				this.$.content.style.width = `${maxWidth}px`;
				this.customStyle['--anaevent-ticker-content-color'] = '#7c149e';
				this.updateStyles();
