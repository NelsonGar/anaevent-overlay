(function () {
	...
	Polymer({
		...
		computeClassIconUrl(playerClass) {
			...
			return `app/anaevent-dotafortress/class_icons/${playerClass}.png`;
		},

		computePortraitUrl(playerClass, index, team) {
			if (index === -1) {
				return 'app/anaevent-dotafortress/portraits/placeholder.webm';
			}

			return `app/anaevent-dotafortress/portraits/${playerClass}/${playerClass}_${index}_${team || 'red'}.webm`;
		},
